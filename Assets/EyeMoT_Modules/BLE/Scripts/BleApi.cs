...
namespace EyeMoT.Ble
{
    public class BleApi
    {
        ...
        [StructLayout(LayoutKind.Sequential, CharSet = CharSet.Unicode)]
        public struct AdvertisementUpdate
        {
            ...
            public short serviceDataSize;

            [MarshalAs(UnmanagedType.I1)]
            public bool serviceDataUpdated;
        ...
        [DllImport("BleWinrtDll.dll", EntryPoint = "StartAdvertisementScan")]
        public static extern void StartAdvertisementScan();

        [DllImport("BleWinrtDll.dll", EntryPoint = "StopAdvertisementScan")]
        public static extern void StopAdvertisementScan();

        [DllImport("BleWinrtDll.dll", EntryPoint = "PollAdvertisement")]
        public static extern ScanStatus PollAdvertisement(ref AdvertisementUpdate adv, bool block);
